!(function (e, t) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define(t)
    : ((e = "undefined" != typeof globalThis ? globalThis : e || self).Picker =
        t());
})(this, function () {
  "use strict";
  function u(e, t) {
      ...
      [
        {
          key: "printRGB",
          value: function (e) {
            var t = (e ? this.rgba : this.rgba.slice(0, 3)).map(function (
              e,
              t
            ) {
              return i(e, 3 === t ? 3 : 0);
      ...
      [
        ...
        },
        {
          ...
          value: function (e) {
            ...
            return void 0 === e
              ? e
              : h.hexToRgb(e.replace(/\-/g, "00").padStart(6, "f"));
          },
        },
        {
          key: "rgbToHsl",
  ...
  function h(e, t, r, n) {
    ...
    void 0 === e ||
      (Array.isArray(e)
        ...
        : void 0 === r
        ? (i = e && "" + e) &&
          ((o = i.toLowerCase()).startsWith("hsl")
            ? ((a = o.match(/([\-\d\.e]+)/g).map(Number)),
              (p = (s = d(a, 4))[0]),
              (c = s[1]),
              (a = s[2]),
              (s = s[3]),
            ...
            : o.startsWith("rgb")
            ? ((p = o.match(/([\-\d\.e]+)/g).map(Number)),
              (a = (c = d(p, 4))[0]),
              (s = c[1]),
              (p = c[2]),
              (c = c[3]),
              (l.rgba = [a, s, p, (c = void 0 === c ? 1 : c)]))
            : o.startsWith("#")
            ? (l.rgba = h.hexToRgb(o))
            : (l.rgba = h.nameToRgb(o) || h.hexToRgb(o)))
        : (this.rgba = [e, t, r, void 0 === n ? 1 : n]));
  }
  var r =
    (e(
      a,
      [
        {
          ...
          value: function (e, t, r) {
            e.addEventListener(t, r, !1),
              this._events.push({ target: e, type: t, handler: r });
          },
        },
        {
          key: "remove",
          value: function (r, n, i) {
            this._events = this._events.filter(function (e) {
              ...
              return (
                ...
                n && n !== e.type && (t = !1),
                (t = i && i !== e.handler ? !1 : t) &&
                  a._doRemove(e.target, e.type, e.handler),
                !t
              );
            });
          },
  ...
  function s(e, o, a) {
    ...
    function r(e, t, r) {
      ...
      (s = r ? !0 : s) &&
        (e.preventDefault(),
        (n = (i = o.getBoundingClientRect()).width),
        (r = i.height),
        (e = t.clientX),
        (t = t.clientY),
        (e = p(e - i.left, 0, n)),
    ...
    function t(e, t) {
      1 === (void 0 === e.buttons ? e.which : e.buttons)
        ? r(e, e, t)
        : (s = !1);
    }
    function n(e, t) {
          ...
          e &&
            ...
            e instanceof HTMLElement
              ...
              : (t.parent &&
                  e.parent &&
                  t.parent !== e.parent &&
                  (this._events.remove(t.parent), (this._popupInited = !1)),
                (function (e, t, r) {
                ...
                (n = e.color || e.colour) && this._setColor(n)),
            (r = t.parent) && t.popup && !this._popupInited
              ? (this._events.add(
                  r,
                  "click",
                  (n = function (e) {
                ...
                b(this._events, r, [" ", "Spacebar", "Enter"], n),
                (this._popupInited = !0))
              : e.parent && !t.popup && this.show());
        },
      },
      {
        key: "openHandler",
        value: function (e) {
          ...
          this.show() &&
            ...
            (t = e && e.type === p ? this._domEdit : this.domElement),
            setTimeout(function () {
              return t.focus();
            }, 100),
        ...
        value: function (e) {
          ...
          e
            ...
            n &&
              ...
              r !== c && this.settings.parent.focus(),
      ...
      },
      {
        ...
        value: function (e, t) {
          if ((e = "string" == typeof e ? e.trim() : e)) {
            ...
            this.settings.alpha || (((e = r.hsla)[3] = 1), (r.hsla = e)),
      ...
      },
      {
        ...
        value: function () {
          ...
          var t =
              ...
              '<div class="picker_wrapper fade-in" tabindex="-1"><div class="picker_arrow"></div><div class="picker_hue picker_slider"><div class="picker_selector"></div></div><div class="picker_sl"><div class="picker_selector"></div></div><div class="picker_alpha picker_slider"><div class="picker_selector"></div></div><div class="picker_editor"><input aria-label="Type a color name or hex value"/></div><div class="picker_sample"></div><div class="picker_done"><button>Ok</button></div><div class="picker_cancel"><button>Cancel</button></div></div>',
            r =
              ((e = t),
          ...
          return (
            (this.domElement = r),
            (this._domH = f(".picker_hue", r)),
            (this._domSL = f(".picker_sl", r)),
            (this._domA = f(".picker_alpha", r)),
            (this._domEdit = f(".picker_editor input", r)),
            (this._domSample = f(".picker_sample", r)),
            (this._domOkay = f(".picker_done button", r)),
            (this._domCancel = f(".picker_cancel button", r)),
            r.classList.add("layout_" + this.settings.layout),
            this.settings.alpha || r.classList.add("no_alpha"),
            this.settings.editor || r.classList.add("no_editor"),
            this.settings.cancelButton || r.classList.add("no_cancel"),
      ...
      },
      {
        ...
        value: function () {
          var r = this.settings.parent,
            n = this.domElement;
          r !== n.parentNode && r.appendChild(n),
      ...
      },
      {
        ...
        value: function (e, t, r, n, i) {
          ...
          [e, t, r, n].forEach(function (e, t) {
            ...
            (o.hsla = a),
            this._updateUI(i),
            this.onChange && !i.silent && this.onChange(o);
        },
      },
      {
        key: "_updateUI",
  ...
  return (
    ...
    document.documentElement.firstElementChild.appendChild(e),
    (_.StyleElement = e),
    _
  );
});
